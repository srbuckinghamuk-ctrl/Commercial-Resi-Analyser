...
10. The phased break-even's per-event fee reservation is paid once per receipt line, so a deposit-heavy document's break-even is overstated relative to its held twin; the timing benefit of a released deposit is visible only with the exit fee removed.
