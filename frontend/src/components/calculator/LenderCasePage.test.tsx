...
const { defaultCalculatorInputsV15 } = await import('../../lib/conversion-defaults');
...
const INPUTS = defaultCalculatorInputsV15({ id: PROJECT.id, price_pence: PROJECT.price_pence, floor_area_sqm: PROJECT.floor_area_sqm });
