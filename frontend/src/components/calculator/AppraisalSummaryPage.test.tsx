...
import type { CalculatorInputsV14, MonitoringStatement, MonitoringStatementLine } from '../../lib/model';
...
function inputsWithIrrecoverableVat(): CalculatorInputsV14 {
  const cloned = JSON.parse(JSON.stringify(vatFixture.inputs)) as CalculatorInputsV14;
