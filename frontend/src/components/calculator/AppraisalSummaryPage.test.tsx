...
import type { CalculatorInputsV15, MonitoringStatement, MonitoringStatementLine } from '../../lib/model';
...
function inputsWithIrrecoverableVat(): CalculatorInputsV15 {
  const cloned = JSON.parse(JSON.stringify(vatFixture.inputs)) as CalculatorInputsV15;
