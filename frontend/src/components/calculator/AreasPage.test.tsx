 ...
 */
function baseInputs(): CalculatorInputsV6 {
...
const inputsFixture: CalculatorInputsV6 = {
  ...baseInputs(),
...
const overfilledInputsFixture: CalculatorInputsV6 = {
  ...baseInputs(),
...
const zeroGiaInputsFixture: CalculatorInputsV6 = {
  ...baseInputs(),
  areas: {
    ...baseInputs().areas,
    existing_gia_sqm: 0,
