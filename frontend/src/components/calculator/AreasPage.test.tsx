 ...
 */
function baseInputs(): CalculatorInputsV15 {
...
const inputsFixture: CalculatorInputsV15 = {
  ...baseInputs(),
...
const overfilledInputsFixture: CalculatorInputsV15 = {
  ...baseInputs(),
...
const zeroGiaInputsFixture: CalculatorInputsV15 = {
  ...baseInputs(),
  areas: {
    ...baseInputs().areas,
    existing_gia_sqm: 0,
